            ...
            <div class="col-twelve">
                ...
                <article class="format-audio">
                    ...
                    <div class="content-media">
                        <div class="post-thumb" style="padding:30px">
                            <img src="{{asset('storage/'.$advertise->photo_audio)}}" width="100%" height="200px">
                        </div>
                        <div class="audio-wrap" style="padding:30px">
                            <audio id="player2" src="{{asset('storage/'.$advertise->audios)}}" width="100%" height="42"
                    ...
                    <div class="primary-content">
                        ...
                        <p><img src="{{$advertise->photos}}" alt=""></p>
